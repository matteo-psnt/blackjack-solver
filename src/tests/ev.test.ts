...
import {
  ...
  evOptimal,
  canDoubleHand,
} from "../core/blackjack/ev"
import type { BlackjackRules, DealerUpcard } from "../core/blackjack/types"
...
function getOutcomes(
  upcard: string,
  rules: BlackjackRules = H17,
  noBlackjack = false
) {
  const memo = createDealerMemo()
  const up = upcard as DealerUpcard
  return noBlackjack
